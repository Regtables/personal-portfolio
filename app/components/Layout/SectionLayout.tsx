...
const SectionLayout = ({ heading, children, hero, left }: Section) => {
  ...
  return (
    <section
      className="flex flex-col min-h-screen section lg:h-screen snap-center relative lg:overflow-hidden lg:px-[6.5rem] px-[1rem]"
      id={heading}
    ...
    >
      ...
      <div ref={ref} className="absolute left-0 top-[40%] h-[1px]" />
      ...
      <div className="relative z-10 h-[100%] lg:h-[85%]">{children}</div>
    </section>
  );
};
